...
#define __PYX_HAVE__chips
#define __PYX_HAVE_API__chips
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'chips' */
...
#define __Pyx_MODULE_NAME "chips"
extern int __pyx_module_is_main_chips;
int __pyx_module_is_main_chips = 0;
...
static const char __pyx_k_chipsize[] = "chipsize";
static const char __pyx_k_generate[] = "generate";
static const char __pyx_k_chips_pyx[] = "chips.pyx";
...
static PyObject *__pyx_kp_s_chips_pyx;
static PyObject *__pyx_n_s_chipsize;
...
static PyObject *__pyx_pf_5chips_generate(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, int __pyx_v_width, int __pyx_v_height, int __pyx_v_chipsize, int __pyx_v_stride); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_5chips_1generate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_5chips_1generate = {"generate", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5chips_1generate, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5chips_1generate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_boxes = 0;
  int __pyx_v_width;
  int __pyx_v_height;
  int __pyx_v_chipsize;
  int __pyx_v_stride;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("generate (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_boxes,&__pyx_n_s_width,&__pyx_n_s_height,&__pyx_n_s_chipsize,&__pyx_n_s_stride,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_width)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("generate", 1, 5, 5, 1); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_height)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate", 1, 5, 5, 2); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_chipsize)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate", 1, 5, 5, 3); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_stride)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate", 1, 5, 5, 4); __PYX_ERR(0, 19, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "generate") < 0)) __PYX_ERR(0, 19, __pyx_L3_error)
      }
    ...
    __pyx_v_width = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_width == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_height = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_height == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_chipsize = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_chipsize == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
  ...
  __Pyx_RaiseArgtupleInvalid("generate", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 19, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("chips.generate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_5chips_generate(__pyx_self, __pyx_v_boxes, __pyx_v_width, __pyx_v_height, __pyx_v_chipsize, __pyx_v_stride);
...
static PyObject *__pyx_pf_5chips_generate(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, int __pyx_v_width, int __pyx_v_height, int __pyx_v_chipsize, int __pyx_v_stride) {
  std::vector<std::vector<float> >  __pyx_v_res;
  ...
  __pyx_pybuffernd_boxes.rcbuffer = &__pyx_pybuffer_boxes;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_boxes.rcbuffer->pybuffer, (PyObject*)__pyx_v_boxes, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 19, __pyx_L1_error)
  }
 ...
 * 
 */
  __pyx_t_1 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_float_3e___(((PyObject *)__pyx_v_boxes)); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L1_error)
  __pyx_v_res = chips::cgenerate(__pyx_v_width, __pyx_v_height, __pyx_v_chipsize, __pyx_t_1, (__pyx_v_boxes->dimensions[0]), __pyx_v_stride);
 ...
 */
  ...
  __pyx_t_2 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_float_3e___(__pyx_v_res); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
...
static int __pyx_pymod_exec_chips(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_chips},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_chips_pyx, __pyx_k_chips_pyx, sizeof(__pyx_k_chips_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_chipsize, __pyx_k_chipsize, sizeof(__pyx_k_chipsize), 0, 0, 1, 1},
 ...
 *     return res
 */
  __pyx_tuple__8 = PyTuple_Pack(6, __pyx_n_s_boxes, __pyx_n_s_width, __pyx_n_s_height, __pyx_n_s_chipsize, __pyx_n_s_stride, __pyx_n_s_res); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(5, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_chips_pyx, __pyx_n_s_generate, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initchips(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initchips(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_chips(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_chips(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_chips(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'chips' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_chips(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("chips", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_chips) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "chips")) {
      if (unlikely(PyDict_SetItemString(modules, "chips", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_numpy, __pyx_t_1) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     return res
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5chips_1generate, NULL, __pyx_n_s_chips); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_generate, __pyx_t_1) < 0) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init chips", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init chips");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
